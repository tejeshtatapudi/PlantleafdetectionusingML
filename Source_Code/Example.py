...
filepath = r'E:\Project\SOURCE CODE (3)\SOURCE CODE\Source code/model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread(r'E:\Project\SOURCE CODE (3)\SOURCE CODE\Source code\Dataset\test\Tomato___Bacterial_spot (1).JPG')
